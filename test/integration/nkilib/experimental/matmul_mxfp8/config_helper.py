...
class TestConfig:
    ...
    @staticmethod
    def _max_tiles(dim: int, tile: int, cap: int = 0) -> int:
        """Max number of tiles that fit in dim, optionally capped. Delegates to KernelConfig."""
        return MatmulMxfp8KernelConfig._max_tiles(dim, tile, cap)
